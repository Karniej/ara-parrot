...
**Requires:** macOS 14+ on Apple Silicon (M1 or newer). Transcription runs on the Apple Neural Engine via CoreML — without ANE the latency story falls apart, so the installer refuses to run on Intel.
