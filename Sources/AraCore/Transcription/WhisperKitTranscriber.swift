...
public actor WhisperKitTranscriber: Transcriber {
    ...
    /// Canonical spellings to bias the decoder with, read fresh per utterance
    /// so a dictionary edit applies without a restart — the same hot-reload
    /// contract the post-transcription replacement already has.
